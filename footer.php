   ...
   <div class="container pt-5">
       <div class="row">
           <div class="col-xs-12 col-sm-6 col-md-4 footers-one">
	            ...
	            <a href="mailto:bootsnipp@gmail.com"><i id="social-em" class="fas fa-envelope-square fa-2x social"></i></a>
	        </div>
    		</div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12 pt-3">
                <p class="text-muted">© 2020 Duong Dat</p>
            </div>
        </div>
    </div>
</section>
